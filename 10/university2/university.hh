 ...
 * The class University has map structures that are added with new elements
 * based on user-given commands, including map containing Courses and
 * another containing Accounts.
 *
 * Only one Account object is created and it's pointed from the class Account,
 * therefore, it is possible for students to sign up and complete (pass) courses.
 * */
...
public:
     ...
     * If the course is already signed up or completed, gives an error.
     * If the account has graduated, gives an error.
     */
