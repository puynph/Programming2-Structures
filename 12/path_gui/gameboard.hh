 ...
 *
 * A public method 'set_board_to_orig' and a private attribute 'original_board'
 * is added to be used in mainwindow.hh in case the user wants to reset.
 * */
#ifndef GAMEBOARD_HH
#define GAMEBOARD_HH
...
public:
    ...
    // Get the original board for game reset
    void set_board_to_orig();
